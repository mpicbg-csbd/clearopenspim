...
/**
 * StageMotionAcquisitionInstruction2
 * <p>
 * <p>
 * <p>
...
public class StageMotionAcquisitionInstruction2 extends LightSheetMicroscopeInstructionBase implements LoggingFeature, PropertyIOableInstructionInterface {
     ...
     */
    public StageMotionAcquisitionInstruction2(LightSheetMicroscope pLightSheetMicroscope) {
        super("Acquisition: Stage motion acquisition", pLightSheetMicroscope);
    }

    public StageMotionAcquisitionInstruction2(String pDeviceName, LightSheetMicroscope pLightSheetMicroscope) {
